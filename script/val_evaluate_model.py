...
def main():
    ...
    #Pour configurer la taille des images
    ...
    # Créeons le dossier 'doc' s'il n'existe pas
    doc_dir = 'doc'
    os.makedirs(doc_dir, exist_ok=True)

    # Générons la documentation pour chaque module et sauvegardons dans le dossier 'doc'
